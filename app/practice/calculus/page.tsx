...
export default function CalculusPractice() {
    const questions = [
        { id: 1, topic: 'Limits', difficulty: 'Easy', solved: false },
        { id: 2, topic: 'Differentiation', difficulty: 'Medium', solved: false },
        { id: 3, topic: 'Applications of Differentiation', difficulty: 'Hard', solved: false },
        { id: 4, topic: 'Integration', difficulty: 'Hard', solved: false },
        { id: 5, topic: 'Applications of Integration', difficulty: 'Very Hard', solved: false },
    ];
        ...
        <main className="min-h-screen py-12">
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h1 className="text-3xl font-bold">∫ Calculus Practice</h1>
                        <p className="text-gray-600 dark:text-gray-400">Limits, derivatives, integration, and applications</p>
                    </div>
