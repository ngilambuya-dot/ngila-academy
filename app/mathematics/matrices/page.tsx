    ...
    return (
        <main className="min-h-screen py-12">
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                <div className="mb-8">
                    <h1 className="text-3xl font-bold mb-2">{meta.name || 'Matrices'}</h1>
                ...
                <div className="space-y-3">
                    {lessons.length > 0 ? (
                        lessons.map((lesson, index) => (
                            <Link
                                key={lesson.slug}
                                href={`/mathematics/matrices/${lesson.slug}`}
                        ...
                        <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-lg border">
                            <p className="text-gray-500 dark:text-gray-400">No lessons available yet for Matrices.</p>
