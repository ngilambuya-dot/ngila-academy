...
export default async function ComplexNumbersPage() {
    ...
    return (
        <main className="min-h-screen py-12">
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                <div className="mb-8">
                    <h1 className="text-3xl font-bold mb-2">{meta.name || 'Complex Numbers'}</h1>
                ...
                <div className="space-y-3">
                    {lessons.map((lesson, index) => (
                        <Link
                            key={lesson.slug}
                            href={`/mathematics/complex-numbers/${lesson.slug}`}
